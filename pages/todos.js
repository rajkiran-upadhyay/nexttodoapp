    ...
    <section class="text-gray-600 body-font">
      <div class="container px-5 py-24 mx-auto">
        <div class="flex flex-col text-center w-full mb-20">
          <h1 class="text-2xl font-medium title-font mb-4 text-gray-900">Your Todos</h1>
          {todos.length==0 && <h1 class="text-2xl font-medium title-font mb-4 text-gray-900">Go add some todos! Its empty</h1>}
          ...
          {todos.map(item => {
            return <div class="p-4 lg:w-1/4 md:w-1/2">
              <div class="h-full flex flex-col items-center text-center">
                <img alt="team" class="flex-shrink-0 rounded-lg w-full h-56 object-cover object-center mb-4" src={`https://picsum.photos/200/300?a=${item.title}`} />
                <div class="w-full">
